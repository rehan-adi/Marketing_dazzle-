...
function Footer() {
  return (
    <footer className="w-full bottom-footer relative">
      {/* Top Footer */}
      <div className="bg-[#000] flex justify-between flex-col gap-14 lg:gap-0 lg:flex-row items-center py-12 lg:py-16 px-4 lg:px-20">
        {/* <div className="absolute top-48 left-[600px]">
            <img src="https://zenfy-next-js.vercel.app/assets/img/home1/footer-logo-bg.png" className="h-auto w-20" alt="hi" />
          </div> */}
        <div class="absolute top-36 left-[650px] transform">
          <img
            src="https://zenfy-next-js.vercel.app/assets/img/footer-logo-dark.svg"
            class="h-auto"
            alt=""
          />
        </div>
        ...
        <div className="w-full lg:w-auto">
          <h1 className="font-extrabold text-white mb-6 text-3xl">
            Our Solutions
          </h1>
          <ul className="text-white flex flex-col gap-5">
            <li className="font-medium tracking-widest text-sm opacity-70">
              Web Development
            </li>
            <li className="font-medium tracking-widest text-sm opacity-70">
              Cyber Security
        ...
        <div className="">
        <h3 className="flex justify-start items-center gap-2 rounded-md font-semibold text-start text-xs text-[#3067FF]">
        ...
        <h1 className="lg:text-4xl text-3xl text-white mt-3 font-bold">What Sets Us Apart?</h1>
        <p className="text-[#B5B5B6] lg:w-[25vw] mt-6 mb-7 font-normal text-base">Welcome to Zenfy, where innovation meets our passion in a journey that started with a simple idea and a shared dream.</p>
        ...
        <div className="flex flex-col gap-1">
            ...
            <div className="lg:border lg:flex hidden opacity-20"></div>
        <div className="flex flex-col gap-1">
              <div className="flex items-center justify-start gap-2">
              <span className="text-[#B5B5B5]">Rivew On</span>
              <span className="flex gap-1">< IoStar  className="text-yellow-400"/>< IoStar className="text-yellow-500"/>< IoStar className="text-yellow-500"/>< IoStar className="text-yellow-500"/>< IoStar className="text-yellow-500"/></span>
              </div>
              <div className="flex  items-center gap-3">
                <img
